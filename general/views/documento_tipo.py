...
from general.serializers import GenDocumentoTipoSeleccionarSerializer
...
class GenDocumentoTipoViewSet(viewsets.GenericViewSet):
    serializer_class = GenDocumentoTipoSeleccionarSerializer
