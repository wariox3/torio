...
class TurProgramacionSimulacionImportarSerializer(serializers.Serializer):
    """
    Define la estructura del Excel de importación de programaciones simuladas y
    la lógica de creación bulk.
    ...
    def procesar_lote(self, filas_validas):
        ...
        if nuevos:
            TurProgramacionSimulacion.objects.bulk_create(nuevos, batch_size=self.BATCH_BULK_CREATE)
        return len(nuevos), []
