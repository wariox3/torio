...
from humano.serializers import (
    HumCargoExportarSerializer,
    HumCargoImportarSerializer,
...
@extend_schema(tags=['Cargo'])
class HumCargoViewSet(
    ...
    @extend_schema(parameters=_SELECCIONAR_PARAMS, responses=HumCargoSeleccionarSerializer(many=True))
    ...
    def seleccionar(self, request):
        ...
        serializer = HumCargoSeleccionarSerializer(pagina, many=True)
