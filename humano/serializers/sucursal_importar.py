...
class HumSucursalImportarSerializer(serializers.Serializer):
    """
    Define la estructura del Excel de importación de sucursales y la lógica de
    creación bulk.
    ...
    def procesar_lote(self, filas_validas):
        ...
        if nuevos:
            HumSucursal.objects.bulk_create(nuevos, batch_size=self.BATCH_BULK_CREATE)
        return len(nuevos), []
