...
class HumCargoImportarSerializer(serializers.Serializer):
    """
    Define la estructura del Excel de importación de cargos y la lógica de
    creación bulk.
    ...
    def procesar_lote(self, filas_validas):
        ...
        if nuevos:
            HumCargo.objects.bulk_create(nuevos, batch_size=self.BATCH_BULK_CREATE)
        return len(nuevos), []
